...
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
      ...
      <path
        fill="#34A853"
        d="M9 18c2.43 0 4.47-.8 5.96-2.17l-2.92-2.27c-.81.55-1.85.87-3.04.87-2.34 0-4.32-1.58-5.03-3.71H.96v2.33A8.997 8.997 0 0 0 9 18z"
      />
      <path
        fill="#FBBC05"
...
export function SocialAuthButton({ label }: { label: string }) {
  return (
    <Button
      ...
      onClick={() => {
        // Delegated to a real OAuth flow (e.g. next-auth's signIn("google"))
